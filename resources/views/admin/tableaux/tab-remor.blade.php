...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Modifier ou Supprimer</h1>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$remorque->n°_de_parc}}</td>
                            <td>
                                <form  action="{{route('edit-remor', $remorque->id)}}" method="get" >
                                    @method('get')
                                    @csrf 
                                    <button type="submit" class="float-left ml-5 btn btn-info">Editer</button>
                                </form>
                                
                                <form  action="{{route('delete-remor', $remorque->id)}}" method="POST" >
                                    @method('POST')
                                    @csrf 
