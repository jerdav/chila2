<div class="card-body">
    <form method="POST" action="{{ route('store-chauf') }}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="form-check mr-5 ml-3">
                <input class="form-check-input" type="radio" name="role_id" id="administrateurs" value=1 checked>
                <label class="form-check-label" for="administrateurs">
                  Administrateurs
                </label>
            </div>
            @endif
