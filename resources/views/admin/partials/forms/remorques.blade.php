<div class="card-body">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="n°_de_parc" type="text" class="form-control @error('n°_de_parc') is-invalid @enderror" name="n°_de_parc" value="{{ old('n°_de_parc') }}" required autocomplete="n°_de_parc" autofocus>
